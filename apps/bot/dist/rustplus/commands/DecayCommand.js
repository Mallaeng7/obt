...
class DecayCommand {
    ...
    async execute(ctx) {
        if (ctx.args.length < 3)
            return '❌ Usage: !decay <hp> <building_block>';
        ...
        if (!building.decayTimeHrs)
            return `❌ '${building.name}' does not decay or data is missing.`;
...
exports.DecayCommand = DecayCommand;
